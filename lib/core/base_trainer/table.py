...
class TableplexeDeeper(nn.Module):

    def __init__(self, ):
        super(TableplexeDeeper, self).__init__()
...
class Tablenet(nn.Module):
    ...
    def forward(self, x):
        ...
        yy = self.dense5(x)
        return xx,yy
class TablenetDeeper(nn.Module):

    def __init__(self, num_features=875, num_targets=206,num_extra_targets=402, hidden_size=512):
        super(TablenetDeeper, self).__init__()



        self.dense1 =TableplexeDeeper()
